...
class TwentyCircles {
	...
	public static function make(){
					...
					Image::canvas(1000,750, '#000000')
							...
							->insert(public_path('uploads/'. $new_name ),'null', $col1, $row2)
							->insert(public_path('uploads/'. $new_name ),'null', $col1, $row3)
							->insert(public_path('uploads/'. $new_name ),'null', $col1, $row4)
							// Col2
							->insert(public_path('uploads/'. $new_name ),'null', $col2, $row1)
							->insert(public_path('uploads/'. $new_name ),'null', $col2, $row2)
							->insert(public_path('uploads/'. $new_name ),'null', $col2, $row3)
							->insert(public_path('uploads/'. $new_name ),'null', $col2, $row4)
							// Col3
							->insert(public_path('uploads/'. $new_name ),'null', $col3, $row1)
							->insert(public_path('uploads/'. $new_name ),'null', $col3, $row2)
							->insert(public_path('uploads/'. $new_name ),'null', $col3, $row3)
							->insert(public_path('uploads/'. $new_name ),'null', $col3, $row4)
							// Col4
							->insert(public_path('uploads/'. $new_name ),'null', $col4, $row1)
							->insert(public_path('uploads/'. $new_name ),'null', $col4, $row2)
							->insert(public_path('uploads/'. $new_name ),'null', $col4, $row3)
							->insert(public_path('uploads/'. $new_name ),'null', $col4, $row4)
							// Col5
							->insert(public_path('uploads/'. $new_name ),'null', $col5, $row1)
							->insert(public_path('uploads/'. $new_name ),'null', $col5, $row2)
							->insert(public_path('uploads/'. $new_name ),'null', $col5, $row3)
							->insert(public_path('uploads/'. $new_name ),'null', $col5, $row4)
							// Col6
							->insert(public_path('uploads/'. $new_name ),'null', $col6, $row1)
							->insert(public_path('uploads/'. $new_name ),'null', $col6, $row2)
							->insert(public_path('uploads/'. $new_name ),'null', $col6, $row3)
							->insert(public_path('uploads/'. $new_name ),'null', $col6, $row4)
